...
client.on('message', message => {
    ...
    .setAuthor("[ Gaint Bot ]", " https://images-ext-2.discordapp.net/external/ahNXTY5REo9rE5-6oa5XGyzSrJis3qbk7eBUv1sEiYI/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/459725014237970492/558a210e07b9ae2504e427a4c7c6d297.png?width=455&height=455")
    .addField("**[ Gaint Prefix] :**","**[ + ]**" , true)
    .addField("** [ Gaint ID ] **", "**"+"459725014237970492"+"**",true)
    .addField("** [ Gaint ] **","** دراجون**")
    ...
    .setColor("ffffff")
    .setFooter(`+help to see all Gaint commands `, ' https://images-ext-2.discordapp.net/external/ahNXTY5REo9rE5-6oa5XGyzSrJis3qbk7eBUv1sEiYI/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/459725014237970492/558a210e07b9ae2504e427a4c7c6d297.png?width=455&height=455')
    message.channel.sendEmbed(embed)
    }
    });

client.on("guildDelete", guild => {
    console.log(` Gaint Left From Server -- = ${guild.name} = -- , Server Owner -- = ${guild.owner.user.username} = --`)
...
const embed = new Discord.RichEmbed()
                   ...
                   .setColor("RANDOM")
                .setFooter(` ©  HeroMC Community™ `)
                .setTitle(" Gaint Left Server !")
...
console.log(` Gaint Added From Server -- = ${guild.name} = -- , Server Owner -- = ${guild.owner.user.username} = --`)
...
const embed = new Discord.RichEmbed()
                   ...
                   .setColor("RANDOM")
                .setFooter(` ©  HeroMC Community™ `)
                .setTitle(" Gaint Added To Server !")
                .addField("**Guild Name:**", guild.name )
                 .addField("**Owner:**", guild.owner.user.username )
                 .addField("**MEMBER COUNT:**", g )
                  .setThumbnail (i)
